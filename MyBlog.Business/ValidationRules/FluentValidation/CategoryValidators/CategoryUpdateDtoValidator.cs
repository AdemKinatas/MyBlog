...
namespace MyBlog.Business.ValidationRules.FluentValidation.CategoryValidators
{
    public class CategoryUpdateDtoValidator : AbstractValidator<CategoryUpdateDto>
    {
        ...
        {
            RuleFor(x => x.Id).NotEmpty().WithMessage("Kategori Id " + ValidationMessages.NotEmpty);
            ...
            RuleFor(x => x.IsDeleted).NotEmpty().WithMessage("Silindi mi? " + ValidationMessages.NotEmpty); 
        }
    }
}
